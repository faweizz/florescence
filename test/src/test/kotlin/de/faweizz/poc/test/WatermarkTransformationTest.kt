...
class WatermarkTransformationTest {
            ...
            createHttpClient().use {
                ...
                it.post<HttpResponse>("http://localhost:8081/sharing-request/${request.id}/transformation") {
                    ...
                    body = TransformationStepAddRequest(
                        transformationStepId = "de.faweizz.topicservice.service.transformation.step.watermark.WatermarkTransformationStep",
                        data = mapOf(
                            "key" to "some-secret-key",
                            "columnsNamesOfColumnsAvailableForMarking" to "birth_year,amount",
                            "markingRatio" to "0.5",
                            "primaryKeyColumnName" to "id"
                        )
                    )
                }
    ...
    companion object {
        private const val TOPIC_NAME = "watermark-source-topic-6"
